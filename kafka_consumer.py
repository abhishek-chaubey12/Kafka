...
def main(topic):
    ...
    while True:
        try:
            ...
            with open('/Users/thestupidmonk/Downloads/Output.txt', 'a', encoding='utf-8') as op_file:
                json.dump(str(restaurant), op_file)
                op_file.write('\n')
                '''json.dump(str(restaurant), op_file, indent=2)'''
